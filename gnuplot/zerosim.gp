...
#
# Plots how the response magnitude would look if given an extra zero
# to cancel a pole at high frequencies.
#
# Datafiles are in three tab-delimited columns: 
# frequency (Hz)    Magnitude (linear)    Phase (degrees)
#
# Usage: call 'zerosim.gp' 'data.dat'
...
replot '$0' using 1:(abs( zero(column(1)) * flatamp )) with lines \
    title 'Single pole 1'
